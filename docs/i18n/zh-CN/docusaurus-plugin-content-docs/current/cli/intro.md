...
[![npm version](https://badge.fury.io/js/@llh911001/claude-code-router.svg)](https://www.npmjs.com/package/@llh911001/claude-code-router)
![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)
![Node Version](https://img.shields.io/node/v/@llh911001/claude-code-router.svg)
...
# 或
pnpm add -g @llh911001/claude-code-router
# 或
yarn global add @llh911001/claude-code-router
```
...
- **CLI** (`@llh911001/claude-code-router`): 提供 `ccr` 命令的命令行工具
